...
{
    public static class EnumHelper<T1>
    {
        ...
        internal static bool initOverlapProc(T1 p1, T1 p2)
        {
            Type typ1 = typeof(T1);
        ...
        internal static bool initHasFlagProc(T1 p1, T1 p2)
        {
            Type typ1 = typeof(T1);
            Type[] types = get_types(ref typ1);
...
namespace ListExtension
{
    ...
    public static partial class Extension
    {
        ...
        // List<ClassTypes>
        public static void write(this List<TactileLibrary.ClassTypes> list, BinaryWriter writer)
        {
            writer.Write(list.Count);
            foreach (int value in list)
        ...
        public static void read(this List<TactileLibrary.ClassTypes> list, BinaryReader reader)
        {
            list.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
                list.Add((TactileLibrary.ClassTypes)reader.ReadInt32());
        }

        // List<Data_Class_Skill>
        public static void write(this List<TactileLibrary.Data_Class_Skill> list, BinaryWriter writer)
        {
            writer.Write(list.Count);
            foreach (TactileLibrary.Data_Class_Skill value in list)
                value.write(writer);
        }

        public static void read(this List<TactileLibrary.Data_Class_Skill> list, BinaryReader reader)
        {
            list.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
                list.Add(TactileLibrary.Data_Class_Skill.read(reader));
        }

        // List<Item_Data>
        public static void write(this List<TactileLibrary.Item_Data> list, BinaryWriter writer)
        {
            writer.Write(list.Count);
            foreach (TactileLibrary.Item_Data value in list)
                value.write(writer);
        }

        public static void read(this List<TactileLibrary.Item_Data> list, BinaryReader reader)
        {
            list.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
        ...
        // List<ShopItemData>
        public static void write(this List<TactileLibrary.ShopItemData> list, BinaryWriter writer)
        {
            writer.Write(list.Count);
            foreach (TactileLibrary.ShopItemData value in list)
                value.write(writer);
        }

        public static void read(this List<TactileLibrary.ShopItemData> list, BinaryReader reader)
        {
            list.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
        ...
        public static void write(this List<TactileLibrary.Battle_Frame_Data> list, BinaryWriter writer)
        {
            writer.Write(list.Count);
            foreach (TactileLibrary.Battle_Frame_Data frame_data in list)
                frame_data.write(writer);
        }

        public static void read(this List<TactileLibrary.Battle_Frame_Data> list, BinaryReader reader)
        {
            list.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
            {
                list.Add(new TactileLibrary.Battle_Frame_Data());
                list[list.Count - 1].read(reader);
            }
        }

        // List<Battle_Frame_Image_Data>
        public static void write(this List<TactileLibrary.Battle_Frame_Image_Data> list, BinaryWriter writer)
        {
            writer.Write(list.Count);
            foreach (TactileLibrary.Battle_Frame_Image_Data image_data in list)
                image_data.write(writer);
        }

        public static void read(this List<TactileLibrary.Battle_Frame_Image_Data> list, BinaryReader reader)
        {
            list.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
            {
                list.Add(TactileLibrary.Battle_Frame_Image_Data.read(reader));
            }
        }

        // List<Sound_Data>
        public static void write(this List<TactileLibrary.Sound_Data> list, BinaryWriter writer)
        {
            writer.Write(list.Count);
            foreach (TactileLibrary.Sound_Data value in list)
                value.write(writer);
        }

        public static void read(this List<TactileLibrary.Sound_Data> list, BinaryReader reader)
        {
            list.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
                list.Add(TactileLibrary.Sound_Data.read(reader));
        }

        // List<Battle_Animation_Tween_Data>
        public static void write(this List<TactileLibrary.Battle_Animation_Tween_Data> list, BinaryWriter writer)
        {
            writer.Write(list.Count);
            foreach (TactileLibrary.Battle_Animation_Tween_Data value in list)
                value.write(writer);
        }

        public static void read(this List<TactileLibrary.Battle_Animation_Tween_Data> list, BinaryReader reader)
        {
            list.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
                list.Add(TactileLibrary.Battle_Animation_Tween_Data.read(reader));
        }

        // List<Event_Data>
        public static void write(this List<TactileLibrary.Event_Data> list, BinaryWriter writer)
        {
            writer.Write(list.Count);
            foreach (TactileLibrary.Event_Data value in list)
                value.write(writer);
        }

        public static void read(this List<TactileLibrary.Event_Data> list, BinaryReader reader)
        {
            list.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
                list.Add(TactileLibrary.Event_Data.read(reader));
        }

        // List<Event_Control>
        public static void write(this List<TactileLibrary.Event_Control> list, BinaryWriter writer)
        {
            writer.Write(list.Count);
            foreach (TactileLibrary.Event_Control value in list)
                value.write(writer);
        }

        public static void read(this List<TactileLibrary.Event_Control> list, BinaryReader reader)
        {
            list.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
                list.Add(TactileLibrary.Event_Control.read(reader));
        }

        // List<TactileLibrary.Support_Entry>
        public static void write(this List<TactileLibrary.Support_Entry> list, BinaryWriter writer)
        {
            writer.Write(list.Count);
            foreach (TactileLibrary.Support_Entry value in list)
                value.write(writer);
        }

        public static void read(this List<TactileLibrary.Support_Entry> list, BinaryReader reader)
        {
            list.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
                list.Add(TactileLibrary.Support_Entry.read(reader));
        }
        
        // List<TactileLibrary.Battler.Battle_Animation_Attack_Set>
        public static void write(this List<TactileLibrary.Battler.Battle_Animation_Attack_Set> list, BinaryWriter writer)
        {
            writer.Write(list.Count);
            foreach (TactileLibrary.Battler.Battle_Animation_Attack_Set value in list)
                value.Write(writer);
        }

        public static void read(this List<TactileLibrary.Battler.Battle_Animation_Attack_Set> list, BinaryReader reader)
        {
            list.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
                list.Add(TactileLibrary.Battler.Battle_Animation_Attack_Set.Read(reader));
        }

        // List<TactileLibrary.Battler.Battle_Animation_Variable_Set>
        public static void write(this List<TactileLibrary.Battler.Battle_Animation_Variable_Set> list, BinaryWriter writer)
        {
            writer.Write(list.Count);
            foreach (TactileLibrary.Battler.Battle_Animation_Variable_Set value in list)
                value.Write(writer);
        }

        public static void read(this List<TactileLibrary.Battler.Battle_Animation_Variable_Set> list, BinaryReader reader)
        {
            list.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
                list.Add(TactileLibrary.Battler.Battle_Animation_Variable_Set.Read(reader));
        }

        // List<Data_Unit>
        public static void write(this List<TactileLibrary.Data_Unit> list, BinaryWriter writer)
        {
            writer.Write(list.Count);
            foreach (TactileLibrary.Data_Unit value in list)
                value.write(writer);
        }

        public static void read(this List<TactileLibrary.Data_Unit> list, BinaryReader reader)
        {
            list.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
                list.Add(TactileLibrary.Data_Unit.read(reader));
        }
    }
}
...
namespace DictionaryExtension
{
    ...
    public static class Extensions
    {
        ...
        // Dictionary<int, List<TactileLibrary.Data_Support>>
        public static void write(this Dictionary<int, List<TactileLibrary.Support_Entry>> dictionary, BinaryWriter writer)
        {
            writer.Write(dictionary.Count);
            foreach (KeyValuePair<int, List<TactileLibrary.Support_Entry>> pair in dictionary)
            {
                writer.Write(pair.Key);
                pair.Value.write(writer);
            }
        ...
        public static void read(this Dictionary<int, List<TactileLibrary.Support_Entry>> dictionary, BinaryReader reader)
        {
            dictionary.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
            {
                int id = reader.ReadInt32();
                List<TactileLibrary.Support_Entry> list = new List<TactileLibrary.Support_Entry>();
                list.read(reader);
                dictionary.Add(id, list);
            }
        }
        ...
        public static void write(this Dictionary<Vector2, TactileLibrary.Data_Unit> dictionary, BinaryWriter writer)
        {
            writer.Write(dictionary.Count);
            foreach (KeyValuePair<Vector2, TactileLibrary.Data_Unit> pair in dictionary)
            {
                pair.Key.write(writer);
                pair.Value.write(writer);
            }
        ...
        public static void read(this Dictionary<Vector2, TactileLibrary.Data_Unit> dictionary, BinaryReader reader)
        {
            dictionary.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
            {
                ...
                Vector2 key = Vector2.Zero;
                key = key.read(reader);
                TactileLibrary.Data_Unit value = TactileLibrary.Data_Unit.read(reader);
                dictionary.Add(key, value);
            }
        }

        // Dictionary<TactileLibrary.Battler.AttackAnims, List<int>>
        public static void write(this Dictionary<TactileLibrary.Battler.AttackAnims, List<int>> dictionary, BinaryWriter writer)
        {
            writer.Write(dictionary.Count);
            foreach (KeyValuePair<TactileLibrary.Battler.AttackAnims, List<int>> pair in dictionary)
            {
        ...
        public static void read(this Dictionary<TactileLibrary.Battler.AttackAnims, List<int>> dictionary, BinaryReader reader)
        {
            dictionary.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
            {
                var key = (TactileLibrary.Battler.AttackAnims)reader.ReadInt16();
                List<int> list = new List<int>();
                list.read(reader);
...
{
    using TactileDataContent = TactileLibrary.TactileDataContent;
    using ITactileDataContentStruct = TactileLibrary.ITactileDataContentStruct;

    public static class Extension
    {
        // List<TactileDataContent>
        public static void Write<T>(this BinaryWriter writer, List<T> list) where T : TactileDataContent
        {
            writer.Write(list.Count);
        ...
        public static void ReadTactileContent<T>(this BinaryReader reader, List<T> list, T existingInstance) where T : TactileDataContent
        {
            list.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
        ...
        // Dictionary<int, TactileDataContent>
        public static void Write<T>(this BinaryWriter writer, Dictionary<int, T> dictionary) where T : TactileDataContent
        {
            writer.Write(dictionary.Count);
        ...
        public static void ReadTactileContent<T>(this BinaryReader reader, Dictionary<int, T> dictionary, T existingInstance) where T : TactileDataContent
        {
            dictionary.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
        ...
        // Dictionary<string, TactileDataContent>
        public static void Write<T>(this BinaryWriter writer, Dictionary<string, T> dictionary) where T : TactileDataContent
        {
            writer.Write(dictionary.Count);
            foreach (var pair in dictionary)
            {
        ...
        public static void ReadTactileContent<T>(this BinaryReader reader, Dictionary<string, T> dictionary, T existingInstance) where T : TactileDataContent
        {
            dictionary.Clear();
            int count = reader.ReadInt32();
            for (int i = 0; i < count; i++)
        ...
        // List<ITactileDataContentStruct>
        public static void WriteStruct<T>(this BinaryWriter writer, List<T> list) where T : ITactileDataContentStruct
        {
            writer.Write(list.Count);
            foreach (T value in list)
                value.Write(writer);
        ...
        public static void ReadTactileContentStruct<T>(this BinaryReader reader, List<T> list) where T : struct, ITactileDataContentStruct
        {
            list.Clear();
            int count = reader.ReadInt32();
