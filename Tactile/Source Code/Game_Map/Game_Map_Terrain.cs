...
namespace Tactile
{
    partial class Game_Map
    {
        ...
        internal int terrain_cost(TactileLibrary.MovementTypes move_type, Vector2 loc)
        {
        ...
        {
            TactileLibrary.Data_Terrain terrain = terrain_data(terrainTag);
        ...
        public HashSet<Vector2> healing_terrain()
        {
            ...
            TactileLibrary.Data_Terrain terrain;
