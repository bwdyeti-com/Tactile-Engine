...
namespace Tactile.Windows.Target
{
    internal class Window_Target_Combat : Window_Target_Unit
    {
        ...
        protected virtual CombatTargetPanel windowskin()
        {
            return new CombatTargetPanel(Global.Content.Load<Texture2D>(@"Graphics/Windowskins/Combat_Window"));
        }
        ...
        protected virtual bool can_counter(Game_Unit unit, Game_Unit target, TactileLibrary.Data_Weapon weapon, int distance)
        {
            // Skills: Old Swoop
