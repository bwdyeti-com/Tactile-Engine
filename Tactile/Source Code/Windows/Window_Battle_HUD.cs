...
namespace Tactile
{
    class Window_Battle_HUD : Sprite
    {
        ...
        protected List<RightAdjustedText> Stat_Imgs = new List<RightAdjustedText>();
        ...
        protected List<TextSprite> Weapon_Names = new List<TextSprite>();
        ...
        protected void initialize(bool reverse, int distance)
        {
            ...
            Combat_Text_Texture = Global.Content.Load<Texture2D>(@"Graphics/Fonts/" + Config.UI_FONT + "_" + "White"); //@Debug
            Combat_Num_Texture = Global.Content.Load<Texture2D>(@"Graphics/Fonts/" + Config.COMBAT_DIGITS_FONT); //@Debug
            Reverse = reverse;
            Distance = distance;
        ...
        protected void setup_images()
        {
            ...
            for (int i = 0; i < (battler_2 == null ? 4 : 8); i++)
            {
                ...
                Stat_Imgs[Stat_Imgs.Count - 1].SetFont(Config.COMBAT_DIGITS_FONT, Global.Content);
            ...
            Names[Names.Count - 1].SetFont(Config.UI_FONT, Global.Content, "White");
            ...
            HP_Count_1.SetFont(Config.COMBAT_DIGITS_FONT, Global.Content);
            ...
            if (battler_2 != null)
            {
                ...
                HP_Count_2.SetFont(Config.COMBAT_DIGITS_FONT, Global.Content);
