...
namespace Tactile
{
    partial class Game_State
    {
        ...
        {
            Global.LoadChapterText(this.chapter.Text_Key);
        }
        ...
        public bool CanActorTalk(int actorId)
        {
            return Talk_Events.Any(x => x.ActorId1 == actorId || x.ActorId2 == actorId);
        }
        ...
        private Maybe<string> get_casual_death_quote(int id, string quote)
        {
            ...
            int current_life = Global.ActorConfig.CasualModeLives - (Global.game_map.units[id].actor.lives - 1);
        ...
        {
            Global.Audio.PlayBattleTheme(Global.BgmConfig.StaffTheme);
        }

        public void play_attack_staff_theme()
        {
            Global.Audio.PlayBattleTheme(Global.BgmConfig.AttackStaffTheme);
        }
        ...
        public void play_dance_theme()
        {
            ...
            Global.Audio.PlayBattleTheme(Global.BgmConfig.DanceTheme); //@Yeti
        }

        public void play_promotion_theme()
        {
            Global.Audio.PlayBattleTheme(Global.BgmConfig.PromotionTheme);
        }
