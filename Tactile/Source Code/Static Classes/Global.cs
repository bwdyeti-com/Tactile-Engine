...
using Tactile.Services.Audio;
using TactileLibrary;
using TactileLibrary.Battler;
using TactileLibrary.Chapters;
using TactileLibrary.Config;
using TactileLibrary.Palette;
...
namespace Tactile
{
    ...
    public static partial class Global
    {
        ...
        public static Tactile.Services.Rumble.BaseRumbleService Rumble
        {
            get
            {
#if DEBUG
                Debug.Assert(Services != null);
#endif
                return ((Tactile.Services.Rumble.BaseRumbleService)
                    Global.services.GetService(
                        typeof(Tactile.Services.Rumble.BaseRumbleService)));
            }
        }
        internal static Tactile.Services.Input.IInputService Input
        {
            get
            {
#if DEBUG
                Debug.Assert(Services != null);
#endif
                return ((Tactile.Services.Input.BaseInputService)
                    Global.services.GetService(
                        typeof(Tactile.Services.Input.BaseInputService)));
            }
        }
        ...
        public static ActorConfig ActorConfig { get { return Constants.Actor; } }
        public static BattleSceneConfig BattleSceneConfig { get { return Constants.BattleScene; } }
        public static BgmConfig BgmConfig { get { return Constants.Bgm; } }
        #endregion
