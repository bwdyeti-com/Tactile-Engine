...
namespace Tactile
{
    class BattlerImageWrapper
    {
        ...
        internal static List<int> attack_animation_value(BattlerSpriteData battler, bool crit, int distance, bool hit)
        {
            ...
            return TactileBattlerImage.attack_animation_value(
        ...
        {
            bool mweapon = battler.MWeapon(distance);
            return TactileBattlerImage.still_animation_value(
                animation_processor(battler, distance), battler.AnimationGroupOffset, crit, hit);
        }
        ...
        {
            return TactileBattlerImage.dance_attack_animation_value(
        ...
        {
            return TactileBattlerImage.dance_still_animation_value(
                animation_processor(battler, 1), battler.AnimationGroupOffset); // Distance? //Yeti
        }
        ...
        internal static List<int> idle_animation_value(BattlerSpriteData battler, int distance)
        {
            ...
            return TactileBattlerImage.idle_animation_value(
        ...
        internal static List<int> avoid_return_animation_value(BattlerSpriteData battler, int distance)
        {
            bool mweapon = battler.MWeapon(distance);
            // this needs to take forceably unequipped anims for dancers into account //Yeti
            return TactileBattlerImage.avoid_return_animation_value(
                animation_processor(battler, distance), battler.AnimationGroupOffset);
        }
        /// <summary>
        ...
        internal static List<int> get_hit_animation_value(BattlerSpriteData battler, bool crit, int distance)
        {
            bool mweapon = battler.MWeapon(distance);
            // this needs to take forceably unequipped anims for dancers into account //Yeti
            return TactileBattlerImage.get_hit_animation_value(
        ...
        internal static List<int> spell_attack_animation_value(int weapon_id, bool magic, int distance, bool hit)
        {
            ...
            return TactileBattlerImage.spell_attack_animation_value(weapon_id, offset, magic, distance, hit);
        }
        ...
        {
            int offset = Global.animation_group("Spells");
            return TactileBattlerImage.spell_attack_animation_value_bg1(weapon_id, offset, magic, distance, hit);
        }
        ...
        {
            int offset = Global.animation_group("Spells");
            return TactileBattlerImage.spell_attack_animation_value_bg2(weapon_id, offset, magic, distance, hit);
        }
        ...
        {
            int offset = Global.animation_group("Spells");
            return TactileBattlerImage.spell_end_animation_value(weapon_id, offset, magic, hit);
        }
        ...
        {
            int offset = Global.animation_group("Spells");
            return TactileBattlerImage.spell_lifedrain_animation_value(weapon_id, offset, magic, distance);
        }
        /// <summary>
