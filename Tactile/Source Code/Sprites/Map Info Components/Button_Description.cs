...
namespace Tactile.Graphics.Help
{
    class Button_Description : UINode
    {
        ...
        public string description
        {
            set
            {
                if (Description is TextSprite)
                {
                    (Description as TextSprite).text = value;

                    refresh_size(Description as TextSprite);
                }
            }
        }
        ...
        protected virtual string DescriptionFont
        {
            get { return Config.UI_FONT; }
        }
        protected virtual string DescriptionFontColor
        {
            get { return "White"; }
        }
        ...
        public int width
        {
            get
            {
                return (int)button_offset.X + (Description is TextSprite ?
                    (Description as TextSprite).text_width : Description.src_rect.Width);
            }
        }
        ...
        protected Button_Description(Buttons button)
        {
            ...
            TextSprite description = new TextSprite();
            description.loc = this.button_offset;
            description.SetFont(this.DescriptionFont, Global.Content, this.DescriptionFontColor);
        ...
        private void refresh_size(TextSprite description)
        {
