...
namespace Tactile
{
    ...
    {
        protected TextSprite Bond_Label, Bond_Name;
        ...
        {
            // Bond Label
            Bond_Label = new TextSprite();
            Bond_Label.loc = new Vector2(12, bond_offset);
            Bond_Label.SetFont(Config.UI_FONT, Global.Content, "Yellow");
            Bond_Label.text = "Bond";
            Bond_Label.stereoscopic = Config.STATUS_LEFT_WINDOW_DEPTH;
            // Bond Name
            Bond_Name = new TextSprite();
            Bond_Name.loc = new Vector2(64, bond_offset);
            Bond_Name.SetFont(Config.UI_FONT, Global.Content, "White");
