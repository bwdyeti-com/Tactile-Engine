...
namespace FEXNA.Windows.Target
{
    class Window_Target_Rescue : Window_Target_Unit
    {
        ...
        FE_Text Name1, Aid_Label, Aid_Value;
        FE_Text Name2, Con_Label, Con_Value;
        Hand_Cursor Hand;
        Sprite Rescue_Icon;
        protected int Mode;
        ...
        protected void initialize_images()
        {
            ...
            // Labels
            Aid_Label = new FE_Text();
            Aid_Label.draw_offset = new Vector2(8, 24 + (!this.target_position_reversed ? 0 : 48));
            Aid_Label.Font = "FE7_Text";
            Aid_Label.texture = Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_Yellow");
            Aid_Label.text = "Aid";
            Con_Label = new FE_Text();
            Con_Label.draw_offset = new Vector2(8, 24 + (this.target_position_reversed ? 0 : 48));
            Con_Label.Font = "FE7_Text";
            Con_Label.texture = Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_Yellow");
            Con_Label.text = "Con";
            // Stats
            Aid_Value = new FE_Text_Int();
            Aid_Value.draw_offset = new Vector2(72, 24 + (!this.target_position_reversed ? 0 : 48));
            Aid_Value.Font = "FE7_Text";
            Aid_Value.texture = Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_Blue");
            Con_Value = new FE_Text_Int();
            Con_Value.draw_offset = new Vector2(72, 24 + (this.target_position_reversed ? 0 : 48));
            Con_Value.Font = "FE7_Text";
            Con_Value.texture = Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_Blue");
            // Hand
