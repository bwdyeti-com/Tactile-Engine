...
namespace FEXNA
{
    class Map_Combat_HUD : Sprite
    {
        ...
        protected void initialize_images()
        {
            Name1 = new FE_Text();
            Name1.Font = "FE7_Text";
            Name1.texture = textures[1];
            Hp1 = hp1;
            HP_Counter1 = new FE_Text_Int();
            HP_Counter1.Font = "FE7_Text_Combat3";
            HP_Counter1.texture = textures[2];
            if (unit_2 != null)
            {
                Name2 = new FE_Text();
                Name2.Font = "FE7_Text";
                Name2.texture = textures[1];
                Hp2 = hp2;
                HP_Counter2 = new FE_Text_Int();
                HP_Counter2.Font = "FE7_Text_Combat3";
                HP_Counter2.texture = textures[2];
                Stat_Imgs = new List<FE_Text_Int>();
                if (Data != null)
                {
                    for (int i = 0; i < 8; i++)
                    {
                        Stat_Imgs.Add(new FE_Text_Int());
                        Stat_Imgs[i].Font = "FE7_Text";
                        Stat_Imgs[i].texture = textures[2];
        ...
        public override void update()
        {
            ...
            if (Stat_Timer > 0)
                Stat_Timer--;
            foreach (FE_Text_Int text in Stat_Imgs)
                text.update();
        }
