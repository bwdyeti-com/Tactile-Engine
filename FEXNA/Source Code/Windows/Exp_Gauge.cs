...
namespace FEXNA
{
    class Exp_Gauge : Sprite
    {
        ...
        {
            get { return Exp; }
            set { Exp = value % Constants.Actor.EXP_TO_LVL; }
        }
        #endregion
        ...
        public Exp_Gauge(int base_exp)
        {
            ...
            Exp_Counter = new FE_Text_Int();
            Exp_Counter.Font = "FE7_Text";
            Exp_Counter.texture = Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_Exp");
        }
