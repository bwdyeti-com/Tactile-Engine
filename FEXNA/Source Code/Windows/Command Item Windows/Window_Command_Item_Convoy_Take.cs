...
namespace FEXNA.Windows.Command.Items
{
    ...
    {
        protected List<FEXNA_Library.Item_Data> Items_Data;
        ...
        protected override void set_items(List<FEXNA_Library.Item_Data> items)
        {
            if (items == null)
                return;
        ...
        public void set_item_data(List<FEXNA_Library.Item_Data> items)
        {
