...
namespace FEXNA.Windows.Command
{
    class Window_Trade : Stereoscopic_Graphic_Object, ISelectionMenu
    {
        ...
        private int Num = Constants.Actor.NUM_ITEMS, Items1, Items2;
        ...
        private FE_Text Equipped_Tag1, Equipped_Tag2;
        ...
        private void initialize_images()
        {
            ...
            Equipped_Tag1 = new FE_Text();
            Equipped_Tag1.Font = "FE7_Text";
            Equipped_Tag1.texture = Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_White");
            Equipped_Tag1.text = "$";
            Equipped_Tag2 = new FE_Text();
            Equipped_Tag2.Font = "FE7_Text";
            Equipped_Tag2.texture = Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_White");
            Equipped_Tag2.text = "$";
        ...
        private void item_node(int unit_index, int index, List<CommandUINode> nodes)
        {
            ...
            FEXNA_Library.Item_Data item_data = unit_index == 0 ?
        ...
        private FEXNA_Library.Item_Data item_data()
        {
            if (this.index == -1 || this.index >= (this.column == 0 ? actor1 : actor2).num_items)
                return new FEXNA_Library.Item_Data();
