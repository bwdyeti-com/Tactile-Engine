...
namespace FEXNA.Windows.Map.Items
{
    class WindowItemList : WindowItemManagement
    {
        ...
        protected override void initialize_sprites()
        {
            ...
            Owner.Font = "FE7_Text";
            Owner.text_colors[0] = "FE7_Text_White";
            Owner.text = "Owner: ";
        ...
        protected override void supply_window_index_changed()
        {
            if (!Supply_Window.can_take)
            {
                ...
                Owner.text = "Owner: ---";
                Owner.text_colors[7] = "FE7_Text_Grey";
            }
            else
            {
                HelpFooter.refresh(
                ...
                {
                    name = "Convoy";
                    Owner.text_colors[7] = "FE7_Text_Yellow";
                }
                else
                {
                    name = Global.game_actors[Supply_Window.active_item.ActorId].name;
                    Owner.text_colors[7] = "FE7_Text_White";
                }
