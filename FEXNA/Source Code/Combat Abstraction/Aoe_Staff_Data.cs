...
namespace FEXNA
{
    class Aoe_Staff_Data : Staff_Data
    {
        ...
        public Aoe_Staff_Data(int battler_1_id, List<int> battler_2_ids)
        {
        ...
        protected override void setup()
        {
            ...
            Func<int, int> divide_by_count = (int value) => value / Battler_2_Ids.Count;
            Wexp1 = Additional_Math.preserve_sign(Wexp1, divide_by_count);
            Exp_Gain1 = Additional_Math.preserve_sign(Exp_Gain1, divide_by_count);
        ...
        public override void apply_combat(bool immediate_level, bool skip_exp)
        {
            ...
            List<int> battler_2_hps = Battler_2_Ids
                .Select(x =>
                {
            ...
            Global.game_state.add_combat_metric(
                ...
                Battler_1_Id, Battler_2_Ids,
                battler_1_hp, battler_2_hps,
            ...
            foreach (int battler_2_id in Battler_2_Ids)
                apply_staff(battler_2_id);
        }
