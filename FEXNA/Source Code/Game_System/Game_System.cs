...
namespace FEXNA
{
    internal partial class Game_System
    {
        ...
        internal Game_Ranking calculate_ranking_progress(FEXNA_Library.Data_Chapter chapter,
        ...
        public void add_event(FEXNA_Library.Event_Data event_data)
        {
