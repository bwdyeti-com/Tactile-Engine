...
namespace FEXNA
{
    ...
    class Text_Window : Text_Box
    {
        ...
        private List<FE_Text> Text_Imgs = new List<FE_Text>();
        ...
        public string text_color
        {
            set
            {
                if (Global.content_exists(string.Format(@"Graphics/Fonts/{0}_{1}",
                    Window_Message.FONT, value)))
                {
                    Color = value;
                    if (Text_Imgs.Any())
                    {
                        var last_text_img = Text_Imgs.Last();
                        last_text_img.text_colors[last_text_img.text.Length] =
        ...
        public Text_Window(int width, int height)
        {
            ...
            SpeakerName.Font = "FE7_Text";
            SpeakerName.texture = Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_White");
        ...
        {
            Text_Imgs.Clear();
            Text_Imgs.Add(new FE_Text());
            Text_Imgs[0].Font = Window_Message.FONT;
            Text_Imgs[0].text_colors[0] = string.Format("{0}_{1}", Window_Message.FONT, Color);
        }
        ...
        public void add_line()
        {
            ...
            Text_Imgs.Add(new FE_Text());
            Text_Imgs[Text_Imgs.Count - 1].Font = Window_Message.FONT;
            Text_Imgs[Text_Imgs.Count - 1].text_colors[0] = string.Format("{0}_{1}", Window_Message.FONT, Color);
        ...
        public void scroll()
        {
            foreach (FE_Text text in Text_Imgs)
