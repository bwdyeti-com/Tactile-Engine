...
namespace FEXNA
{
    class Unit_Info_Panel_Combat_Preview : Sprite
    {
        ...
        protected FE_Text_Int Hp1, Dmg1, Hit1, Crt1, ASpd1;
        protected FE_Text_Int Hp2, Dmg2, Hit2, Crt2, ASpd2;
        ...
        private static FE_Text_Int stat_text()
        {
            var text = new FE_Text_Int();
            text.Font = "FE7_Text_Info";
            text.texture = Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_Info");
            return text;
        }
