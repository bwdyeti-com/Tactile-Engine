...
{
    class Battle_Hit_Number : FE_Text
    {
        ...
        private int max_time
        {
            get
            {
                return MIN_TIME + Math.Min(Constants.Actor.MAX_HP, Math.Max(40, Value));
            }
        }
        #endregion
        ...
        public Battle_Hit_Number(int value, float vel)
        {
            ...
            Font = "FE7_Text";
            this.texture = Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_Red");
            text = value.ToString();
