...
namespace FEXNA
{
    ...
    internal partial class Scene_Map : Scene_Level_Up
    {
        ...
        // Turn Skip Text
        private FE_Text Turn_Skip_Text;
        ...
        {
            Turn_Skip_Text = new FE_Text();
            Turn_Skip_Text.Font = "FE7_Text";
            Turn_Skip_Text.texture = Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_White");
        ...
        private void draw_unit_support_gain(SpriteBatch spriteBatch)
        {
            ...
            {
                var parameters = Global.game_state.support_gain_gfx;
                ...
                if (spriteBatch.GraphicsDevice.ScissorRectangle.Width > 0 && spriteBatch.GraphicsDevice.ScissorRectangle.Width > 0)
                {
                    ...
                    foreach (int id in Global.game_state.support_gain_ids
                        .Where(x => Global.game_map.units.ContainsKey(x)))
                    {
                        ...
                        spriteBatch.Draw(SupportIcons,
                            Vector2.Transform(support_bubble_loc, camera.matrix),
                            new Rectangle(0, 32, 8, 8), parameters.Tint, 0f,
