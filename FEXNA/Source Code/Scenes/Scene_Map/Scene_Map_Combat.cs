    ...
    partial class Scene_Map
    {
        ...
        public void create_hud(Combat_Data data)
        {
            Combat_HUD = new Map_Combat_HUD(new List<Texture2D> {
                ...
                Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_Combat3")}, data);
            //if (data.Battler_2_Id != null) //Yeti
            //    Combat_HUD.set_stats(data.Data[0].Key.Stats);
        }
        public void create_hud(int unit_id)
        {
            Combat_HUD = new Map_Combat_HUD(new List<Texture2D> {
                Global.Content.Load<Texture2D>(@"Graphics/Windowskins/Map_Combat_HUD"),
                Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_White"),
                Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_Combat3")}, unit_id);
        }
        public void create_hud(int unit_id1, int unit_id2)
        {
            Combat_HUD = new Map_Combat_HUD(new List<Texture2D> {
                Global.Content.Load<Texture2D>(@"Graphics/Windowskins/Map_Combat_HUD"),
                Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_White"),
                Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_Combat3")}, unit_id1, unit_id2);
        }
