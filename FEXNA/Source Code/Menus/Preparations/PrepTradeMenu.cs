...
namespace FEXNA.Windows
{
    class PrepTradeMenu : Windows.Map.Map_Window_Base, ISelectionMenu
    {
        ...
        protected FE_Text Name_1, Name_2;
        ...
        protected void initialize_sprites(int id1, int id2)
        {
            ...
            Name_1.Font = "FE7_Text";
            Name_1.texture = Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_White");
            ...
            Name_2.Font = "FE7_Text";
            Name_2.texture = Global.Content.Load<Texture2D>(@"Graphics/Fonts/FE7_Text_White");
