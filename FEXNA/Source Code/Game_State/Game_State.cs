...
namespace FEXNA
{
    internal partial class Game_State
    {
        ...
        internal HashSet<int> support_gain_ids { get { return SupportState.support_gain_ids; } }

        public SpriteParameters support_gain_gfx { get { return SupportState.support_gain_gfx; } }
