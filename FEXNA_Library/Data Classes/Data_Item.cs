...
namespace FEXNA_Library
{
    ...
    public partial class Data_Item : Data_Equipment
    {
        ...
        {
            Data_Item result = new Data_Item();
            result.read_equipment(reader);
            
            result.Heal_Val = reader.ReadInt32();
            result.Heal_Percent = (float)reader.ReadDouble();
            result.Door_Key = reader.ReadBoolean();
            result.Chest_Key = reader.ReadBoolean();
            result.Dancer_Ring = reader.ReadBoolean();
            result.Torch_Radius = reader.ReadInt32();
            result.Placeable = (Placeables)reader.ReadInt32();
            result.Repair_Val = reader.ReadInt32();
            result.Repair_Percent = (float)reader.ReadDouble();
            result.Boost_Text = reader.ReadString();
            result.Stat_Boost = result.Stat_Boost.read(reader);
            result.Growth_Boost = result.Growth_Boost.read(reader);
            result.Stat_Buff = result.Stat_Buff.read(reader);
            result.Promotes.read(reader);
